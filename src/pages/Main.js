        ...
        <ThemeProvider theme={Theme}>
            ...
            <Container>
                {gradeInfo.image && (
                    <Logo
                        src={gradeInfo.image}
                        alt={`${gradeInfo.name} Logo`}
                    />
                )}
                <Header>Mutside Out</Header>
                {userGrade && (
                    <UserGrade>유저 등급: {gradeInfo.name}</UserGrade>
                )}
                <Menu>
                    <MenuItem onClick={() => navigate('/planners')}>
                        플래너
                    </MenuItem>
                    <MenuItem onClick={() => navigate('/diaries')}>
                        감정일기
                    </MenuItem>
                    <MenuItem onClick={() => navigate('/rooms')}>
                        집중세션
                    </MenuItem>
                    <MenuItem onClick={() => navigate('/pomodoro')}>
                        뽀모도로
                    </MenuItem>
                </Menu>
                {alertMessage && (
